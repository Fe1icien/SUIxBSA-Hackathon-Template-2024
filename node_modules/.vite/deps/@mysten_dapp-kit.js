import {
  ...
  useQuery,
  useSuspenseQuery
} from "./chunk-AXAL2O7V.js";
import {
  SuiClient,
  getFullnodeUrl,
  isSuiClient
} from "./chunk-7YW7KE7M.js";
import {
  Transaction,
  literal,
  object,
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState18 = React38.useState, useEffect20 = React38.useEffect, useLayoutEffect7 = React38.useLayoutEffect, useDebugValue2 = React38.useDebugValue;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useRef16 = React38.useRef, useEffect20 = React38.useEffect, useMemo9 = React38.useMemo, useDebugValue2 = React38.useDebugValue;
...
function createContextScope2(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    function Provider(props) {
      ...
      const value2 = React26.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime8.jsx)(Context.Provider, { value: value2, children });
    }
    function useContext23(consumerName, scope) {
      const Context = (scope == null ? void 0 : scope[scopeName][index2]) || BaseContext;
...
function useLatestRef(value2) {
  const ref = React29.useRef(value2);
  index(() => {
    ref.current = value2;
  });
  return ref;
...
function createContextScope3(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    function Provider(props) {
      const { scope, children, ...context } = props;
      const Context = (scope == null ? void 0 : scope[scopeName][index2]) || BaseContext;
      const value2 = React31.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime12.jsx)(Context.Provider, { value: value2, children });
    }
    function useContext23(consumerName, scope) {
      const Context = (scope == null ? void 0 : scope[scopeName][index2]) || BaseContext;
...
function createContextScope4(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    function Provider(props) {
      const { scope, children, ...context } = props;
      const Context = (scope == null ? void 0 : scope[scopeName][index2]) || BaseContext;
      const value2 = React34.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime14.jsx)(Context.Provider, { value: value2, children });
    }
    function useContext23(consumerName, scope) {
      const Context = (scope == null ? void 0 : scope[scopeName][index2]) || BaseContext;
...
// node_modules/@vanilla-extract/css/dist/transformCss-9c456b50.browser.esm.js
...
var StyleMarker = (0, import_react10.forwardRef)(({ children, ...props }, forwardedRef) => (0, import_jsx_runtime20.jsx)(Slot, { ref: forwardedRef, ...props, ...styleDataAttribute, children }));
...
function WalletListItem({ name, icon, onClick, isSelected = false }) {
  return (0, import_jsx_runtime30.jsx)("li", { className: container7, children: (0, import_jsx_runtime30.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        typeof icon === "string" ? (0, import_jsx_runtime30.jsx)("img", { className: walletIcon2, src: icon, alt: `${name} logo` }) : icon,
...
function WalletList({ selectedWalletName, onPlaceholderClick, onSelect }) {
  ...
  return (0, import_jsx_runtime31.jsx)("ul", { className: container6, children: wallets2.length > 0 ? wallets2.map((wallet) => (0, import_jsx_runtime31.jsx)(
    WalletListItem,
    {
      name: wallet.name,
      icon: wallet.icon,
...
function SuiClientProvider(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(SuiClientContext.Provider, { value: ctx, children });
}
...
function CheckIcon(props) {
  return (0, import_jsx_runtime34.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none", ...props, children: (0, import_jsx_runtime34.jsx)(
    "path",
    {
      fill: "currentColor",
...
function ChevronIcon(props) {
  return (0, import_jsx_runtime35.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none", ...props, children: (0, import_jsx_runtime35.jsx)(
    "path",
    {
      stroke: "#A0B6C3",
      strokeLinecap: "round",
...
function AccountDropdownMenu({ currentAccount }) {
  ...
  return (0, import_jsx_runtime36.jsxs)(Root23, { modal: false, children: [
    (0, import_jsx_runtime36.jsx)(StyleMarker, { children: (0, import_jsx_runtime36.jsx)(Trigger2, { asChild: true, children: (0, import_jsx_runtime36.jsxs)(Button, { size: "lg", className: connectedAccount, children: [
      (0, import_jsx_runtime36.jsx)(Text, { mono: true, weight: "bold", children: currentAccount.label ?? domain ?? formatAddress(currentAccount.address) }),
      (0, import_jsx_runtime36.jsx)(ChevronIcon, {})
    ] }) }) }),
    (0, import_jsx_runtime36.jsx)(Portal22, { children: (0, import_jsx_runtime36.jsx)(StyleMarker, { className: menuContainer, children: (0, import_jsx_runtime36.jsxs)(Content23, { className: menuContent, children: [
      accounts.map((account) => (0, import_jsx_runtime36.jsx)(
      ...
      (0, import_jsx_runtime36.jsx)(Separator2, { className: separator }),
...
function AccountDropdownMenuItem({
  ...
  return (0, import_jsx_runtime36.jsxs)(
    Item22,
    {
      ...
      children: [
        (0, import_jsx_runtime36.jsx)(Text, { mono: true, children: account.label ?? domain ?? formatAddress(account.address) }),
        active ? (0, import_jsx_runtime36.jsx)(CheckIcon, {}) : null
      ]
    }
  );
}
function ConnectButton({
  ...
  return currentAccount ? (0, import_jsx_runtime37.jsx)(AccountDropdownMenu, { currentAccount }) : (0, import_jsx_runtime37.jsx)(
    ConnectModal,
    {
      trigger: (0, import_jsx_runtime37.jsx)(StyleMarker, { children: (0, import_jsx_runtime37.jsx)(Button, { ...buttonProps, children: connectText }) })
    }
  );
}
...
function WalletProvider({
  ...
  return (0, import_jsx_runtime39.jsx)(WalletContext.Provider, { value: storeRef.current, children: (0, import_jsx_runtime39.jsxs)(
    WalletConnectionManager,
    {
      ...
      stashedWallet,
      children: [
        theme ? (0, import_jsx_runtime39.jsx)(InjectedThemeStyles, { theme }) : null,
        children
      ]
    }
  ) });
